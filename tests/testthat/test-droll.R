test_that("droll() for outcomes works", {
  d6 <- d(1:6)
  d20 <- d(1:20)
  d10 <- d(1:10)
  ...
  wide <- droll(3 * (2 * d6) + d20 + 1 * d10 - 1 + 4)
...
test_that("droll() for counts works", {
  d6 <- d(1:6)
  d20 <- d(1:20)
  d10 <- d(1:10)
  deven <- d(c(2, 4, 6, 8, 10))
...
test_that("droll() for frequencies works", {
  d6 <- d(1:6)
  d20 <- d(1:20)
  d10 <- d(1:10)
  deven <- d(c(2, 4, 6, 8, 10))
