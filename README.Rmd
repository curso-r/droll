...
check DCs on the fly. Players might also find it usefull for determining the
best course of action when in a tought situation.

It is designed to be a very light weight (only one required dependency), very
...
function discussed above. This skips all internal calculations, so it's a usefull
